/*
    Apply new items to the list in this format
...
exports.items = [{
    ...
    'label': 'Async',
    'src': "https://github.com/caolan/async",
    ...
    'label': "Blanket",
    'src': "http://migrii.github.com/blanket/",
    'description': "Blanket.js is an easy to install, easy to configure, and easy to use JavaScript code coverage library that works both in-browser and with nodejs."
},{
    'label': "Bootstrap",
    ...
    'label': "Bower",
    'src': "http://twitter.github.com/bower/",
    'description': "Bower is a package manager for the web. Bower lets you easily install assets such as images, CSS and JavaScript, and manages dependencies for you."
},{
    'label': "Buster.js",
    ...
    'label': "Istanbul",
    'src': "https://github.com/yahoo/istanbul",
    ...
    'label': "Mocha",
    'src': "http://visionmedia.github.com/mocha/",
    'description': "Mocha is a feature-rich JavaScript test framework running on node and the browser, making asynchronous testing simple and fun. Mocha tests run serially, allowing for flexible and accurate reporting, while mapping uncaught exceptions to the correct test cases."
},{
   'label': "MochiKit",
